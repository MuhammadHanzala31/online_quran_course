        ...
        <main>
                ...
                <div className='max-w-7xl w-full mx-auto lg:px-4 px-8 lg:py-5 py-4  '>
                    <div className='flex lg:flex-row flex-col items-center gap-5 justify-between'>
                        <div className='flex flex-col gap-2 w-full lg:w-1/2'>
                            <h1 className='text-[#FFB706] font-bold font-jakarta text-[16px] lg:text-[20px] '>A Strong Foundation in Quran Reading</h1>
                            <h1 className='text-white font-bold font-jakarta text-[32px] lg:text-[54px] '>Basic Alphabets (Qaida) Course </h1>
                            <h1 className='text-[#FFB706] font-bold font-jakarta text-[16px] lg:text-[20px] '>Our Promise To Uphold The Trust Placed</h1>
                            <p className='text-white font-normal text-[15px] lg:text-[18px] font-jakarta'>Welcome to OQC Institute, where our Basic Alphabets (Qaida) Course provides the essential foundation for accurate Quran reading. This comprehensive course is designed for beginners of all ages who want to start their Quranic journey from the very basics. Students learn Arabic letters, correct pronunciation (Makharij), joining letters, vowel signs (Harakat), Sukoon, Madd, and other fundamental Tajweed rules through structured and easy-to-follow lessons.</p>
                            <p className='text-white font-normal text-[15px] lg:text-[18px] font-jakarta'>Our certified tutors ensure a supportive and engaging environment where every learner builds confidence step by step. We are committed to helping students develop a strong base that prepares them for fluent and accurate Quran recitation.</p>

                        </div>
                        <div className='w-full lg:w-1/2 justify-center lg:justify-end flex'>
            ...
            <SectionLayout>
                <div className='flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0'>
                    ...
                    <div className='flex flex-col gap-6 w-full lg:w-[45%] justify-end'>
                        <h2 className='text-black font-medium font-poppins text-[26px] lg:text-[36px] '>Best Quran Academy For Basic Qaida Course</h2>
            ...
            <SectionLayout>
                <div className='flex justify-start flex-col text-start my-3'>
                    <h3 className='text-black font-poppins text-[26px] lg:text-[36px] font-medium'>A Step-by-Step Journey to Accurate Quran Reading </h3>
                ...
                <div className='flex flex-col gap-3'>
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0'>
                        ...
                        <div className='flex flex-col gap-6 w-full lg:w-1/2'>
                            <h1 className='text-black font-medium font-poppins text-[26px] lg:text-[36px] '> Arabic Alphabet Recognition</h1>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0'>
                        ...
                        <div className='flex flex-col gap-6 w-full lg:w-1/2'>
                            <h1 className='text-black font-medium font-poppins text-[26px] lg:text-[36px] '> Harakat & Basic Tajweed Rules</h1>
                    ...
                    <div className='flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0'>
                        ...
                        <div className='flex flex-col gap-6 w-full lg:w-1/2'>
                            <h1 className='text-black font-medium font-poppins text-[26px] lg:text-[36px] '> Advanced Qaida Practice</h1>
            ...
            <SectionLayout>
                <div className='lg:w-1/2 w-full flex flex-col gap-4 mb-6'>
                    <h1 className='text-black font-medium font-poppins text-[26px] lg:text-[36px] '>More About this course</h1>
