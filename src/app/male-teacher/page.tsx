...
import banner from '@/../public/adult.png'
                ...
                <div className='max-w-[1400px] w-full mx-auto lg:px-4 px-8 lg:my-[0px] my-7 lg:py-10 py-4 '>
                    <div className='flex lg:flex-row flex-col items-center'>
                        <div className='flex flex-col gap-3 lg:w-[40%] w-full'>
                            <h2 className='text-[54px] font-jakarta font-bold text-black tracking-tight'>Male Quran Teachers at OQC Institute</h2>
                            <p className='text-sm sm:text-base md:text-lg mt-3 font-poppins font-normal text-[#535353] '>Discover OQC Institute’s dedicated <strong> Male Quran Teachers </strong>, committed to spreading Quranic knowledge through effective and interactive online learning. Our male instructors are highly skilled in Tajweed, Tarteel, and Quran recitation, offering personalized lessons that help students build a strong and meaningful connection with the Holy Quran from anywhere in the world.</p>
                        </div>
