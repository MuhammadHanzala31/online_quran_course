...
import single1 from '@/../public/male-1.jpeg'
import single2 from '@/../public/male-2.jpeg'
...
export default function MeetTeachers() {
    ...
    const cards = [
        {
            _id : 1,
            text : 'At OQC Institute, our expert male tutors combine deep Islamic knowledge with compassionate teaching. They are more than just instructors — they are role models who inspire students to develop a lasting relationship with the Holy Quran.',
            image : single1
        },
        {
            _id : 1,
            text : 'Each teacher has years of experience in online Quran instruction and is fluent in multiple languages to help students learn with ease and confidence. From beginners taking their first steps in Quran recitation to advanced learners studying Tafseer or memorization, our male teachers adapt their approach to suit every student’s needs',
            image : single2
        },
    ]
