...
export default function BlogBanner() {
    return (
        <div className='flex gap-9 justify-center items-center flex-col bg-[#098A46] py-[120px]'>
            <h3 className='text-white font-medium font-poppins lg:text-5xl text-3xl'>Our Blogs</h3>
            <div className='flex gap-2 items-center'>
                ...
                <span className='text-lg font-jakarta text-[#FFB706] font-medium'>Blogs</span>
            </div>
        </div>
    )
}
