                    ...
                    <div className='flex lg:flex-row flex-col items-center w-full'>
                        <div className='lg:w-1/2 w-full'>
                            <div className='flex flex-col gap-9 w-[90%]'>
                                <h2 className='lg:text-6xl text-[32px] font-jakarta font-bold text-black'>Learn <span className='text-[#098A46]'>Quran Online </span>  in  <span className='text-[#098A46]' >UK</span></h2>
            ...
            <SectionLayout>
                <div className='flex lg:flex-row flex-col'>
                    ...
                    <div className='lg:w-1/2 w-full flex flex-col gap-6'>
                        ...
                        <h3 className='text-4xl font-poppins font-medium leading-[115%]'>OQC Academy – Trusted  <span className='text-[#098A46]'> Online Quran Academy In Uk </span></h3>
